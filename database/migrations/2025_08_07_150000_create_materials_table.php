...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('materials', function (Blueprint $table) {
            ...
            $table->tinyInteger('status')->default(Material::BORRADOR)->comment('Product::PUBLICADO = 1, Product::BORRADOR = 3, Product::ELIMINADO = 0, Product::ARCHIVADO = 2]'); //desde -128 a 127
